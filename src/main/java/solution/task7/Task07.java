...
public class Task07 {
    public static void main(String[] args) {
        Cheese cheese = new Cheese(100, "Gouda");
        Cake cake = new Cake(200, "bread", 50);
        Salt salt = new Salt(0.2);
        Tomato tomato = new Tomato(TomatoSize.MEDIUM, "cherry", "sweet");
        Dish sandwich = new Dish(new Ingredient[]{cheese, cake, salt});
        Dish breakfast = new Dish(new Ingredient[] {sandwich, tomato});
        System.out.println("Calories of breakfast " + breakfast.calories());
        System.out.println("Weight of breakfast " + breakfast.weight());
    }
}
